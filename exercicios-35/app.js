...
// myKey é o nome que estou dando a chave

const getLocalStorageKey = keyName => {
  const keyValue = localStorage.getItem(keyName)
  return JSON.parse(keyValue)
}

console.log(getLocalStorageKey('myKey'))
/*
  02
...
const combineOperations = (initValue, arrOfFuncs) => {
  arrOfFuncs.reduce((acc, func) => {
    return func(acc)
  }, initValue)
}

console.log(combineOperations(0, [add100, divByFive, multiplyByThree, addTen]))
