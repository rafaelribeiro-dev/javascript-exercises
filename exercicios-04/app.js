...
const myFavoriteTVShows = ['Spiderman', 'Avengers', 'Ironman']
...
const typeSentece = `O tipo de dado que a const "isRandomTVShowIncluded" armazena é: ${typeof isRandomTVShowIncluded}.`

console.log(typeSentece)
/*
...
caracteres? ${String(typeSentece > sentenceLength).replace('f', 'F')}.`)
...
console.log(`Todos os ${
  falsyValues.length
} itens do array "falsyValues" são falsy. Inclusive o  
${typeof falsyValues === 'boolean'}.`)
/*
