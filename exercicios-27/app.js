...
setTimeout(() => {
  console.log('código assíncrono sendo executado')
}, 2000)
...
const filteredNumbers = num => num < 5
const lesserThanFive = numbers.filter(filteredNumbers)
...
console.log((secondCar.color = 'azul'))
/*
  06
...
const myFunc = (name, surName, age) => {
  if ([name, surName, age].includes(undefined)) {
    return `A função deve ser invocada com 3 argumentos`
  }
  return `os 3 Argumentos Passados: ${name} ${surName}, ${age}`
}

console.log(myFunc('Rafael', 'Alves', 35))
