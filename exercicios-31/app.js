...
logGitHubUser('rafaelribeiro-dev')
...
console.log(`numeros divisiveis por 2 ou 3: `, newNumbers)
...
const myName = ['Ra', 'fa', 'el']
const name2 = ['He', 'le', 'na']
const name3 = ['Jo', 'a', 'quim']
const nameInPLanguage = name => name.reduce((acc, item) => `${acc}P${item}`, '')

console.log(nameInPLanguage(myName))
console.log(nameInPLanguage(name2))
console.log(nameInPLanguage(name3))
...
const logMessage = firstName
  .split('')
  .map((letter, index) => `${letter} é a ${index + 1}ª letra do meu nome`)
