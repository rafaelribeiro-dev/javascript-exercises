...
const newColour = object => {
  object['color'] += ` and Brown`
}

newColour(cat)
const colourProperty = 'color'

console.log(`cores do gato: ${cat[colourProperty]}`)
/*
  06
...
let dog = {
  ...
  age: 2,
  color: 'caramelo',
  bestFriends: ['thor', 'Ginger'],
  sound: function () {
    return 'AuAu'
  }
}

const getSumAges = (cat, dog) => {
  const sumAges = cat.age + dog.age
  console.log(`A soma das idades de ${cat.name} e ${dog.name} é ${sumAges}.`)
}
