/*
Desafio: Criar uma aplicação de lista de tarefas
...
A aplicação deve ser construída usando HTML, CSS e JavaScript (puro ou com ajuda de algum framework, como jQuery)

Deve ser possível adicionar uma nova tarefa a lista, informando apenas a descrição da tarefa

Deve ser possível marcar uma tarefa como concluída, mudando a cor de fundo da tarefa para verde

Deve ser possível remover uma tarefa da lista

Deve ser mantido o estado da lista (tarefas adicionadas, marcadas como concluídas ou removidas) mesmo após atualização da página
