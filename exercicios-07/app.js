...
const isLionExist = animals.includes('leão')
...
for (let i = 0; i < randomValues.length; i++) {
  ...
  if (typeof randomValues[i] === 'string') {
    stringsAmount++
    fourStrings.push(randomValues[i])
  }
...
const lastFourStrings = fourStrings[fourStrings.length - 1]
const firstFourStrings = fourStrings
  .join(', ')
  .replace(`, ${lastFourStrings}`, ` e ${lastFourStrings}`)
...
console.log(`3 informações sobre o array randomValues:
  ...
  - O array foi iterado por ${iterationsAmount} vezes.`)
