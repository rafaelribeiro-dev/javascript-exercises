...
//   const currectGender = gender === 'Feminino' ? 'a' : 'o'
//   const yearPluralOrSingular = getPluralOrSingular(age, 'ano', 'anos')
...
//   return `oi. Eu sou ${currectGender} ${name} ${lastName}, tenho ${age} ${yearPluralOrSingular},
// ${height} metros de altura, peso ${weight} quilos e, só hoje, eu já caminhei ${walkedMeters} ${fitMeters}`
// }

// console.log(person.introducing())
...
// const truthyValues = [true, () => {}, {}, [], -1, 'false', '0']
...
const getBook = bookName => {
  ...
  /* curto circuito para eliminar a redundancia de se usar o ternario
  book[bookName] ? book[bookName] : book
   */
  return book[bookName] || book
}

console.log(getBook('A arte da guerra'))
