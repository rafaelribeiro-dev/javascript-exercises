...
const past = new Date('Jun 1 2022 05:20:10')

console.log('Começei a estudar em: ', past)
...
const future = new Date('Apr 11 2023 18:33:51')
...
console.log('diferença de dias entre datas é de', differenceInDays, 'dias')
