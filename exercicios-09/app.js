...
const sentenceLength = string => string.length

console.log(sentenceLength('Rafael'))
...
const showInLowerCase = string => string.toLowerCase()

const phrase = 'CHOCOTONE E OVO DE PÁSCOA JUNTOS NO MERCADO EM PLENO FEVEREIRO'
console.log(showInLowerCase(phrase))
...
const indexOfCaracter = (caracter, string) => {
  return string.indexOf(caracter)
}

console.log(indexOfCaracter('l', 'Rafael'))
...
const existInArray = (item, array) => array.includes(item)

console.log(existInArray('Bola', ['Pedra', 'Papel', 'Tesoura']))
...
console.log(
  concatArrays(
    ['Spiderman', 'Thor', 'Iron-man'],
    ['Hulk', 'Doctor Strange', 'Romanov']
  )
)
/*
  07
...
console.log(removeLastItem(['HTML', 'CSS', 'JAVASCRIPT', 'JAVA']))
...
// Crie outra função que apenas exibe seu nome no console;
const printMyName = () => {
  console.log('Parabéns Rafael você conseguiu! ')
}

invokeCallback(printMyName)
